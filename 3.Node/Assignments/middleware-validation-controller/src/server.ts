...
import { getAllUsers, getUserById, registerUser, updateUser, deleteUser } from "../middleware/controller/userController";
import { validateRegistration, validateUpdate } from "../middleware/validator/requestValidation";
...
app.put('/update', validateUpdate,updateUser);
